...
if ($profiling) {
    plc_debug_prof('04: persons', count($persons));
}
...
if ($profiling) {
    plc_debug_prof('05: nodes', count($slice_nodes));
}

////////////////////
// outline the number of reservable nodes
$nodes_message = count_english($slice_nodes, "node");
if (count($reservable_nodes)) {
    $nodes_message .= " (" . count($reservable_nodes) . " reservable)";
}
...
if ($profiling) {
    plc_debug_prof('11: nodes in', count($slice_nodes));
}
